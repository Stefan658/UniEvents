        ...
        <div className="flex justify-between h-[72px] py-2">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-4 group">
              ...
              <span className="text-2xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-br from-primary-600 to-primary-900 ml-7">
                UniEvents
              </span>
            </Link>
            ...
            <div className="hidden sm:ml-10 sm:flex sm:space-x-1">
              ...
              <a 
                ...
                className="px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center space-x-2 text-gray-500 hover:bg-gray-50 hover:text-gray-900"
              >
                <Clock className="h-4 w-4 text-gray-400" />
                <span>USV Schedule</span>
